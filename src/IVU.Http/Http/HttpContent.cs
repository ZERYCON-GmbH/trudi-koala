...
namespace IVU.Http
{
    ...
    {
        private IVU.Http.Headers.HttpContentHeaders _headers;
        ...
        public IVU.Http.Headers.HttpContentHeaders Headers
        {
            get
            {
                if (_headers == null)
                {
                    _headers = new IVU.Http.Headers.HttpContentHeaders(this);
                }
                return _headers;
            }
        }
        ...
        internal static string ReadBufferAsString(ArraySegment<byte> buffer, IVU.Http.Headers.HttpContentHeaders headers)
        {
