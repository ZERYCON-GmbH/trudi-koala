...
namespace IVU.Http
{
    ...
    public class MultipartFormDataContent : MultipartContent
    {
        ...
        public override void Add(HttpContent content)
        {
            ...
            {
                content.Headers.ContentDisposition = new Headers.ContentDispositionHeaderValue(formData);
            }
        ...
        private void AddInternal(HttpContent content, string name, string fileName)
        {
            if (content.Headers.ContentDisposition == null)
            {
                Headers.ContentDispositionHeaderValue header = new Headers.ContentDispositionHeaderValue(formData);
                header.Name = name;
