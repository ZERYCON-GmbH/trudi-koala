...
namespace IVU.Http
{
    ...
    public class MultipartContent : HttpContent, IEnumerable<HttpContent>
    {
        ...
        public MultipartContent(string subtype, string boundary)
        {
            ...
            IVU.Http.Headers.MediaTypeHeaderValue contentType = new IVU.Http.Headers.MediaTypeHeaderValue("multipart/" + subtype);
            contentType.Parameters.Add(new IVU.Http.Headers.NameValueHeaderValue(nameof(boundary), quotedBoundary));
