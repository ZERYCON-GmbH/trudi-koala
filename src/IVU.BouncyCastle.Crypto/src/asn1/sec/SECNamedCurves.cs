...
namespace Org.BouncyCastle.Asn1.Sec
{
    public sealed class SecNamedCurves
    {
        ...
        internal class Brainpoolp224r1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigInteger p = FromHex("D7C134AA264366862A18302575D1D787B09F075797DA89F57EC8C0FF");
                BigInteger a = FromHex("68A5E62CA9CE6C1C299803A6C1530B514E182AD8B0042A59CAD29F43");
                BigInteger b = FromHex("2580F63CCFE44138870713B1A92369E33E2135D266DBB372386C400B");

                // curve seed for GF(p)
                byte[] S = Hex.Decode("5F4BF8D8D8C31D763DA06C80ABB1185EB4F7C7B5");
        ...
        internal class Brainpoolp256r1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigInteger p = FromHex("A9FB57DBA1EEA9BC3E660A909D838D726E3BF623D52620282013481D1F6E5377");
                BigInteger a = FromHex("7D5A0975FC2C3057EEF67530417AFFE7FB8055C126DC5C6CE94A4B44F330B5D9");
                BigInteger b = FromHex("26DC5C6CE94A4B44F330B5D9BBD77CBF958416295CF7E1CE6BCCDC18FF8C07B6");

                // curve seed for GF(p)
                byte[] S = Hex.Decode("757F5958490CFD47D7C19BB42158D9554F7B46BC");
        ...
        internal class Brainpoolp320r1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigInteger p = FromHex("D35E472036BC4FB7E13C785ED201E065F98FCFA6F6F40DEF4F92B9EC7893EC28FCD412B1F1B32E27");
                BigInteger a = FromHex("3EE30B568FBAB0F883CCEBD46D3F3BB8A2A73513F5EB79DA66190EB085FFA9F492F375A97D860EB4");
                BigInteger b = FromHex("520883949DFDBC42D3AD198640688A6FE13F41349554B49ACC31DCCD884539816F5EB4AC8FB1F1A6");

                // curve seed for GF(p)
                byte[] S = Hex.Decode("ED55C4D79FD5F24D6613C31C3839A2DDF8A9A276");
        ...
        internal class Brainpoolp384r1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigInteger p = FromHex("8CB91E82A3386D280F5D6F7E50E641DF152F7109ED5456B412B1DA197FB71123ACD3A729901D1A71874700133107EC53");
                BigInteger a = FromHex("7BC382C63D8C150C3C72080ACE05AFA0C2BEA28E4FB22787139165EFBA91F90F8AA5814A503AD4EB04A8C7DD22CE2826");
                BigInteger b = FromHex("04A8C7DD22CE28268B39B55416F0447C2FB77DE107DCD2A62E880EA53EEB62D57CB4390295DBC9943AB78696FA504C11");

                // curve seed for GF(p)
                byte[] S = Hex.Decode("BCFBFA1C877C56284DAB79CD4C2B3293D20E9E5E");
        ...
        internal class Brainpoolp512r1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                BigInteger p = FromHex("AADD9DB8DBE9C48B3FD4E6AE33C9FC07CB308DB3B3C9D20ED6639CCA703308717D4D9B009BC66842AECDA12AE6A380E62881FF2F2D82C68528AA6056583A48F3");
                BigInteger a = FromHex("7830A3318B603B89E2327145AC234CC594CBDD8D3DF91610A83441CAEA9863BC2DED5D5AA8253AA10A2EF1C98B9AC8B57F1117A72BF2C7B9E7C1AC4D77FC94CA");
                BigInteger b = FromHex("3DF91610A83441CAEA9863BC2DED5D5AA8253AA10A2EF1C98B9AC8B57F1117A72BF2C7B9E7C1AC4D77FC94CADC083E67984050B75EBAE5DD2809BD638016F723");

                // curve seed for GF(p)
                byte[] S = Hex.Decode("AF02AC60ACC93ED874422A52ECB238FEEE5AB6AD");
        ...
        static SecNamedCurves()
        {
            ...
            // Brainpool curves
            DefineCurve("brainpoolp224r1", SecObjectIdentifiers.BrainpoolP224r1, Brainpoolp224r1Holder.Instance);
            DefineCurve("brainpoolp256r1", SecObjectIdentifiers.BrainpoolP256r1, Brainpoolp256r1Holder.Instance);
            DefineCurve("brainpoolp320r1", SecObjectIdentifiers.BrainpoolP320r1, Brainpoolp320r1Holder.Instance);
            DefineCurve("brainpoolp384r1", SecObjectIdentifiers.BrainpoolP384r1, Brainpoolp384r1Holder.Instance);
            DefineCurve("brainpoolp512r1", SecObjectIdentifiers.BrainpoolP512r1, Brainpoolp512r1Holder.Instance);
